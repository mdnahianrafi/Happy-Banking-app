...
const StickyNav = () => {
  return (
    <div className="sticky bottom-0 left-0 right-0 z-50 bg-white flex justify-between rounded-t-lg shadow-[0_-2px_10px_rgba(0,0,0,0.1)] px-3 py-[10px] w-full sm:px-6 sm:py-3">
